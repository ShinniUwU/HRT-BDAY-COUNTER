document.addEventListener('DOMContentLoaded', function() {
    ...
    function countdown() {
        ...
        if (isItApril5th && currentTime.getDate() === 6 && currentTime.getMonth() === 3) {
...
if (daysHRT > 0) {
    ...
    if (daysHRT === 0 && date_2.getDate() === 20 && date_2.getMonth() === 9) {
        document.getElementById("hrt").innerHTML = "Happy HRT Anniversary!";
